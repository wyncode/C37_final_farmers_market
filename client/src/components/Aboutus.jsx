      ...
      <div className="card-container">
        <div class="card">
          ...
          <div class="container">
            <h2>Katie Breuil</h2>
            <p class="title">
              Full-Stack Developer, Concept & Design Wyncode Cohort 37
            </p>
            <p>
              {' '}
              Katie is a Web Development student at Wyncode, who is excited to
              create solutions to every day problems with technology.
            </p>
            <p>katie@example.com</p>
            <p>
              <a href="mailto: katie@example.com">
        ...
        <div class="card">
          ...
          <div class="container">
            ...
            <p>
              Roberto is a Web Development student at Wyncode, who is excited to
              create solutions to every day problems with technology.
            </p>
