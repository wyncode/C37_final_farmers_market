...
const Login = () => {
    ...
    const logIn = async (email, password, e) => {
        ...
        .catch((e) => {console.log(e.message.toString(), "Credentials Error")})
    }
    ...
    return(
      ...
      <form onSubmit={e => logIn(email, password, e)}>
          ...
          <input type="password" name="password" placeholder="enter your secret passcode" value={password} onChange={ e => setPassword(e.target.value)} required />
