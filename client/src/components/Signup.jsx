...
const Signup = () => {
  ...
  const signUp = async (name,email,password,address,apt,city,state,zipcode,cardName,cardNumber,expirationDate,e) => {
    e.preventDefault();
    await axios({
      method: 'POST',
      url: `/users`,
      ...
      <div className="static-checkout-div">
        <div className="miniformdiv">
          ...
          <form id="form3" className="hide" onSubmit={form3}>
            ...
            <button className="checkout-button" type="submit" onClick={(e)=>signUp(name,
    email,
    password,
    address,
    apt,
